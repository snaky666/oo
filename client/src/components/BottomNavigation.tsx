            ...
            if (item.label === "الحساب") {
              return (
                <div key={`profile-${idx}`} className="relative group">
                  ...
                  {/* Profile Dropdown */}
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-32 bg-background border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 origin-bottom">
                    {user && (
                      <>
