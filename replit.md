...
## نظرة عامة
منصة ويب عربية متكاملة لبيع وشراء الأغنام مع نظام إشراف إداري كامل. المنصة مخصصة للسوق الجزائري وتدعم ثلاثة أنواع من المستخدمين: المشترين والبائعين والإداريين.
...
## آخر التحديثات:
- 2025-11-22: تم تحويل المنصة من السعودية إلى الجزائر:
  - تغيير العملة من "ر.س" (ريال سعودي) إلى "DA" (دينار جزائري)
  - استبدال المدن السعودية بـ 58 ولاية جزائرية
  - تحديث أمثلة أرقام الهاتف إلى الصيغة الجزائرية
  - تحديث جميع الصفحات والمكونات (browse, seller-dashboard, seller-profile, components) ✅
- 2025-11-22: تم إضافة عرض البيانات الشخصية للبائعين في لوحة الإدارة:
  - إضافة tab جديد "البائعون" في admin-dashboard
  - عرض جدول كامل لجميع البائعين مع بياناتهم:
    - البريد الإلكتروني
    - الاسم الكامل
    - رقم الهاتف
    - المدينة
    - العنوان التفصيلي
    - تاريخ التسجيل
  - يتم تصفية المستخدمين تلقائياً للحصول على البائعين فقط (role = seller)
  - عداد ديناميكي يظهر عدد البائعين ✅
